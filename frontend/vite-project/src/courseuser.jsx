...
return <Card style={{minHeight:200,
 ...
 <Button  variant="contained" onClick={async()=>{
   ...
   const resp= await axios.post("http://localhost:3000/users/courses/"+currCourse.id,{},{
    headers:{
     "Authorization" : "Bearer "+localStorage.getItem("token")
    }})
...
<Typography variant="h6" style={{marginLeft:100,marginTop:10}} >Early bird price of <b>₹{props.course.price}/${Math.ceil(props.course.price/83.18)}</b></Typography>
